var T=Object.defineProperty;var l=(e,r)=>T(e,"name",{value:r,configurable:!0});import"./jsx-runtime.4de53506.js";import{aL as o,aM as V,aN as _,aO as g,aP as W,aQ as B}from"./Props.3d2e646d.js";import"./iframe.ad698d62.js";import{d as P,j as y,o as k,b as m,e as N,m as I,k as j,F as K,g as M,t as E,i as G,r as S}from"./vue.esm-bundler.7a829ca1.js";import{c as x,u as O}from"./utils.afff62ba.js";import{_ as A}from"./_plugin-vue_export-helper.cdc0426e.js";import{r as d,a as i,H as L}from"./s-head.92084ec3.js";import"./string.ca0947f5.js";import"./es.map.constructor.5de2711d.js";import"./es.number.to-fixed.53ef4e64.js";const C=P({name:"KCheckbox",props:{modelValue:{type:Boolean,default:!1},value:{type:[String,Number,Boolean,Object,Array,Symbol],default:""},label:{type:String,default:""},color:{type:String,control:"inline-radio",options:x,validator:e=>x.includes(e),default:"primary",description:"Color del bot\xF3n"}},emits:["update:modelValue"],setup(e,r){const n=O(),t=l(a=>!!r.slots[a],"hasSlot"),b=y(()=>{let a=[];return e.color==="white"||e.color==="black"?a.push("text-black focus:ring-black dark:focus:ring-white dark:text-black k-checkbox-inverse"):e.color==="gray"?a.push("text-gray-300 focus:ring-gray-300 dark:focus:ring-gray-300"):e.color==="primary"?a.push("text-primary focus:ring-primary dark:focus:ring-primary"):e.color==="secondary"?a.push("text-secondary focus:ring-secondary dark:focus:ring-secondary"):e.color==="success"?a.push("text-success focus:ring-success dark:focus:ring-success"):e.color==="warning"?a.push("text-warning focus:ring-warning dark:focus:ring-warning"):e.color==="danger"?a.push("text-danger focus:ring-danger dark:focus:ring-danger"):e.color==="info"&&a.push("text-info focus:ring-info dark:focus:ring-info"),a}),f=l(a=>{u.value=a.target.value},"change"),u=y({get(){return e.modelValue},set(a){r.emit("update:modelValue",a)}});return{model:u,hasSlot:t,inputId:n,classes:b,change:f}}});const $={class:"flex items-center"},H=["id","checked","value"],X=["for"];function F(e,r,n,t,b,f){return k(),m("div",$,[N("input",{id:e.inputId,checked:e.model===e.value,value:e.value,type:"checkbox",class:I(["k-checkbox w-4 h-4 border-gray-300 rounded dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600",e.classes]),onChange:r[0]||(r[0]=(...u)=>e.change&&e.change(...u))},null,42,H),e.label||e.hasSlot("default")?(k(),m("label",{key:0,for:e.inputId,class:"ml-2 text-sm font-medium text-gray-900 dark:text-gray-300 select-none"},[e.hasSlot("default")?j(e.$slots,"default",{key:0},void 0,!0):(k(),m(K,{key:1},[M(E(e.label),1)],64))],8,X)):G("",!0)])}l(F,"_sfc_render");const c=A(C,[["render",F],["__scopeId","data-v-9ad2c7b4"]]);C.__docgenInfo={displayName:"KCheckbox",exportName:"default",description:"",tags:{},props:[{name:"modelValue",type:{name:"boolean"},defaultValue:{func:!1,value:"false"}},{name:"value",type:{name:"string|number|boolean|object|array|symbol"},defaultValue:{func:!1,value:"''"}},{name:"label",type:{name:"string"},defaultValue:{func:!1,value:"''"}},{name:"color",type:{name:"string"},defaultValue:{func:!1,value:"'primary'"}}],events:[{name:"update:modelValue"}],slots:[{name:"default"}]};function p(){return p=Object.assign?Object.assign.bind():function(e){for(var r=1;r<arguments.length;r++){var n=arguments[r];for(var t in n)Object.prototype.hasOwnProperty.call(n,t)&&(e[t]=n[t])}return e},p.apply(this,arguments)}l(p,"_extends");const v=l(e=>({components:{KCheckbox:c},setup(){return{args:e}},template:'<k-card><k-checkbox v-bind="args">Checkbox Label</k-checkbox></k-card>'}),"Template"),z={Template:v},q="wrapper";function w({components:e,...r}){return o(q,p({},z,r,{components:e,mdxType:"MDXLayout"}),o(B,{title:"Data Entry/Checkbox",component:c,argTypes:i(c),decorators:[()=>({template:'<div class="flex items-center justify-center p-10"><story /></div>'})],mdxType:"Meta"}),o(L,{image:"https://media0.giphy.com/media/hDSy8w6rGHeTe/giphy.gif?cid=ecf05e47d1yojdu59ttft3ykom3decoar5aubq8zin0w9sov&rid=giphy.gif&ct=g",mdxType:"SHead"},"\u{1F6CE} KCheckbox"),o("h1",null,"KCheckbox"),o("p",null,"Con el componente ",o("inlineCode",{parentName:"p"},"k-checkbox")," puedes marcar o desmarcar una opci\xF3n. Util para booleanos."),o(g,{name:"Default",parameters:d({showPanel:!0}),mdxType:"Story"},v.bind({})),o(W,{story:"Default",mdxType:"ArgsTable"}),o("h2",null,o("strong",{parentName:"h2"},"Color")),o("p",null,"Existen diferentes estilos de colores para los botones. Muchos de ellos se usan para definir una accion en el sistema."),o(_,{mdxType:"Canvas"},o(g,{name:"Color",argTypes:i(c,{},!0),parameters:d({showPanel:!1}),mdxType:"Story"},()=>({components:{KCheckbox:c},setup(){return{value:S("White/Black")}},template:`
...
//# sourceMappingURL=k-checkbox.story.e19aa9c5.js.map
