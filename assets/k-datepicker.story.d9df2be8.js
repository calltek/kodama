...
}`},...t({showPanel:!1})};const o={title:"Data Entry/Datepicker",decorators:[()=>({template:'<div class="flex items-center justify-center p-10"><story /></div>'})],component:a,argTypes:r(a),includeStories:["defaultStory","time","range","multi","fixedDates","minMax","inline","status","errors","sizes","fieldset"]},I={Default:"defaultStory",Time:"time",Range:"range",Multi:"multi","Fixed Dates":"fixedDates","Min/Max":"minMax",Inline:"inline",Status:"status",Errors:"errors",Sizes:"sizes",Fieldset:"fieldset"};o.parameters=o.parameters||{};o.parameters.docs={...o.parameters.docs||{},page:()=>e(N,{mdxStoryNameToKey:I,mdxComponentAnnotations:o},e(M,null))};const J=["Template","defaultStory","time","range","multi","fixedDates","minMax","inline","status","errors","sizes","fieldset"];export{u as Template,J as __namedExportsOrder,o as default,C as defaultStory,T as errors,b as fieldset,y as fixedDates,D as inline,v as minMax,x as multi,g as range,h as sizes,S as status,f as time};
//# sourceMappingURL=k-datepicker.story.d9df2be8.js.map
