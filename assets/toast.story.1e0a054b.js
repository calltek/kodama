var y=Object.defineProperty;var s=(o,e)=>y(o,"name",{value:e,configurable:!0});import"./jsx-runtime.5230863f.js";import{aL as t,aM as f,aN as l,aO as g,aQ as m}from"./Props.3d43f305.js";import"./iframe.b502473d.js";import{r as a,H as L}from"./s-head.5f39cb3b.js";import{L as r}from"./vue.esm-bundler.3fc53486.js";import"./string.404bb550.js";import"./es.map.constructor.26a5de70.js";import"./es.number.to-fixed.3e646e7f.js";function p(){return p=Object.assign?Object.assign.bind():function(o){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var c in n)Object.prototype.hasOwnProperty.call(n,c)&&(o[c]=n[c])}return o},p.apply(this,arguments)}s(p,"_extends");const k=s(()=>({setup(){const o=r("toast");return{showToast:s(()=>{o.info("Lorem ipsum dolor sit amet et quantum di quero ni tibi")},"showToast")}},template:'<k-button v-bind="args" @click="showToast">Show toast</k-button>'}),"Template"),S={Template:k},x="wrapper";function h({components:o,...e}){return t(x,p({},S,e,{components:o,mdxType:"MDXLayout"}),t(g,{title:"Plugins/Toast",decorators:[()=>({template:'<div class="flex items-center justify-center p-10"><story /></div>'})],mdxType:"Meta"}),t(L,{image:"https://media2.giphy.com/media/SwImQhtiNA7io/giphy.gif?cid=ecf05e47z82yq5bzlbtacqrphv0r4tr1wtbmnhzeakchqa9a&rid=giphy.gif&ct=g",mdxType:"SHead"},"\u2328 KInput"),t("h1",null,"KInput"),t("p",null,"Con el componente ",t("inlineCode",{parentName:"p"},"k-input")," puedes renderizar un input text para solicitar contenido."),t(l,{name:"Default",parameters:a({showPanel:!0}),mdxType:"Story"},k.bind({})),t("h2",null,t("strong",{parentName:"h2"},"Types")),t("p",null,"Puedes "),t(m,{mdxType:"Canvas"},t(l,{name:"Types",parameters:a({showPanel:!1}),mdxType:"Story"},()=>({setup(){const n=r("toast");return{showToast:s(u=>{n[u]("Lorem ipsum dolor sit")},"showToast")}},template:`
          ...
          <k-button color="danger" class="mr-4" @click="showToast('error')">Danger</k-button>
  ...
  setup() {
    ...
    const showToast = () => {
      toast.info('Lorem ipsum dolor sit amet et quantum di quero ni tibi');
    };
    return {
      showToast
    };
...
}`},...a({showPanel:!1})};const i={title:"Plugins/Toast",decorators:[()=>({template:'<div class="flex items-center justify-center p-10"><story /></div>'})],includeStories:["defaultStory","types","title","position"]},C={Default:"defaultStory",Types:"types",Title:"title",Position:"position"};i.parameters=i.parameters||{};i.parameters.docs={...i.parameters.docs||{},page:()=>t(f,{mdxStoryNameToKey:C,mdxComponentAnnotations:i},t(h,null))};const O=["Template","defaultStory","types","title","position"];export{k as Template,O as __namedExportsOrder,i as default,b as defaultStory,d as position,w as title,T as types};
//# sourceMappingURL=toast.story.1e0a054b.js.map
