...
}`},...o({showPanel:!1})};const s={title:"Data Display/Date",decorators:[()=>({template:'<div class="flex items-center justify-center p-10"><story /></div>'})],component:a,argTypes:m(a),includeStories:["defaultStory","ranges"]},C={Default:"defaultStory",Ranges:"ranges"};s.parameters=s.parameters||{};s.parameters.docs={...s.parameters.docs||{},page:()=>e(v,{mdxStoryNameToKey:C,mdxComponentAnnotations:s},e(y,null))};const X=["Template","defaultStory","ranges"];export{d as Template,X as __namedExportsOrder,s as default,g as defaultStory,u as ranges};
//# sourceMappingURL=k-date.story.b47e11d0.js.map
