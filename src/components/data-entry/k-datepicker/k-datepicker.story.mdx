...
<SHead image="https://media2.giphy.com/media/JIX9t2j0ZTN9S/giphy.gif?cid=ecf05e47k3mnhrb7yc36brvbtq2tz34x1c5odz3ckvei9tmc&rid=giphy.gif&ct=g">📆 KDatepicker</SHead>
...
Tambien puedes especificar un numero mínimo y máximo de días con las propiedades `minRange` y `maxRange`.
        ...
        template: `
          <k-card>
            <div class="flex flex-col gap-8">
              ...
              <k-datepicker range min-range="3">Con Rango <sup>(Mínimo 3 dias)</sup></k-datepicker>
              <k-datepicker range max-range="5">Con Rango <sup>(Máximo 5 dias)</sup></k-datepicker>
            </div>
          </k-card>
        `,
      };
...
## **Multi Calendario**
Al establecer la propiedad `multi` a true se añaden dos calendarios. Útil para el modo rango de fechas.
