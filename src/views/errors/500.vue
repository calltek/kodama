<template>
    ...
    >
        ...
        >
            ...
            <img :src="img500" alt="" class="mw-100 mb-10 h-lg-450px" />
            ...
            <div class="pt-lg-10 mb-10">
                ...
                <div class="fw-bold fs-3 text-muted mb-15">
                    Algo no funcionó como debería!<br />
                    Inténtalo más tarde.
                </div>
...
<script lang="ts">
    ...
    export default defineComponent({
        ...
        setup() {
            const img500 = computed(() => {
                const random = randomNumber(1, 4)
                return `https://kodamaui.s3.eu-west-1.amazonaws.com/errors/500/500-${random}.svg`
            })
